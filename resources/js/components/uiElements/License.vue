<template>
    <span>
        <i v-if="licenseId === 1" class="far fa-question-circle"></i>
        <i v-if="licenseId === 2" class="far fa-copyright"></i>

        <i v-if="licenseId >= 3 " class="fab fa-creative-commons"></i>
        <i v-if="licenseId === 3" class="fab fa-creative-commons-zero"></i>
