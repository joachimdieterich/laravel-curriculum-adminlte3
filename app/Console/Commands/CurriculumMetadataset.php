...
class CurriculumMetadataset extends Command
{
    ...
    {
        DB::table('curricula')->where('ui', $duplicates)->update(['ui' => null]);
        DB::table('terminal_objectives')->where('ui', $duplicates)->update(['ui' => null]);
        DB::table('enabling_objectives')->where('ui', $duplicates)->update(['ui' => null]);
    }
}
