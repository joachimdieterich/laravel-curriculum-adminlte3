 ...
 *     description="Returns a collection with the common_name, admin-permissions and an array of permissions",
 *     security={
 *          {"bearerAuth": {}},
 *     },
 *     @OA\Parameter(
 ...
 *         @OA\JsonContent(
 *             type="object",
 *             @OA\Property(property="common_name", type="string", format="uuid"),
 *             @OA\Property(property="is_admin", type="boolean"),
 *             @OA\Property(
 *                 property="permissions",
 *                 type="array",
 *                 example={"videoconference_access", "videoconference_create", "user_edit"},
