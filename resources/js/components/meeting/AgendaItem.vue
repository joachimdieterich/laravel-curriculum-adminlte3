<template>
    <div>
        ...
        <div class="timeline-item">
            ...
            >
                <VideoConference v-if="item.videoconferences.length == 0"
                    modus="add"
...
import AgendaItemMedia from "./AgendaItemMedia.vue";
